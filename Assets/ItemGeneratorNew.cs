                ...
                else
                {
                    ...
                    for (int j = -1; j <= 1; j++)
                    {
                        ...
                        if (1 <= item && item <= 6)
                        {
                            ...
                            coin.transform.position = new Vector3(posRange * j, coin.transform.position.y, unitychanPosZ + 40);
                        }
                        else if (7 <= item && item <= 9)
                        {
                            //車を作成
                            GameObject car = Instantiate(carPrefab);
                            car.transform.position = new Vector3(posRange * j, car.transform.position.y, unitychanPosZ + 40);
                        }
                    }
